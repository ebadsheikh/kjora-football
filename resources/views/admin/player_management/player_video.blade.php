        ...
        <div class="w-11/12">
            ...
            <div class="p-3">
                <a href="#" class="flex items-center ">
                    ...
                    <span>
                        <h1 class="uppercase text-white text-lg md:text-2xl font-semibold tracking-wide">video
                        </h1>
                    </span>
                </a>
            </div>
                                        ...
                                        <div class="flex-col md:flex md:flex-row py-3">
                                            ...
                                            <div>
                                                <a href="#" class="flex items-center">
                                                    ...
                                                    <img src="{{asset('assets/images/star-icon.svg')}}" class=" ml-3 mb-5"
                                                        alt="Logo" />
                                                </a>
                                                        ...
                                                        <div class="grow">
                                                            <div class="flex flex-col">
                                                                ...
                                                                <div class="flex space-x-2">
                                                                    <button type="button"
                                                                        class="text-black text-xs font-medium">Like</button>
                                                                    <button type="button"
                                                                        class="text-black text-xs font-medium">Reply</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
