...
@section('content')
    <div class="py-12 px-5 md:mx-12 2xl:mx-32 2xl:mt-48">
        <form action="{{Route('admin.billing.update', $billings->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
                @if (session('success'))
                <div class="p-2">
                    ...
                    <div class="md:px-6 pt-8 md:pt-32 lg:py-24 xl:pt-36 2xl:pt-40">
                        <div class="mt-3">
                            ...
                            <div class="relative items-center">
                                ...
                                name="name" placeholder="Enter Billing" autocomplete="off" value="{{$billings->name}}">
                                @error('name')
