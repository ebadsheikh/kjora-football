...
@section('content')
                                    ...
                                    <div>
                                        <a href="" class="flex items-center">
                                            ...
                                            <span class="self-center">
                                                <h1 class="text-white text-sm md:text-base md:leading-none uppercase">
                                                    @if ($card_detail->first_name == 1)
                                                        {{$default_account->first_name}}
                                                    @endif
                                                    @if ($card_detail->sur_name == 1)
                                                        {{$default_account->sur_name}}
                                                    @endif
                                                </h1>
                                                <h2
                                                    class="text-heading-white text-opacity-25 font-medium text-sm md:text-base">
                                                    <span>@</span>{{$default_account->player_user_name}}
                                                </h2>
                                ...
                                <div class="my-3">
                                    <div class="flex justify-between md:justify-around">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h2 class="text-white text-xs md:text-sm">{{ get_age_from_birth_date($default_account->date_of_birth) }}</h2>
                                            @endif
                                        </div>
                                        <div class="text-center">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h1 class="text-heading-white text-opacity-25 text-xs md:text-sm">
                                                Position</h1>
                                                    ...
                                                    <h2 class="text-white text-xs md:text-sm">{{$default_account->position['name']}}</h2>
                                                @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <a href="#" class="flex items-center">
                                        <img src="{{ asset('assets/images/white-location.svg') }}" class="mr-1"
                                            ...
                                            @if ($card_detail->location == 1)
                                                <h1 class="text-white text-xs">{{$default_account->current_address}}</h1>
                                            @endif
                                    </a>
                                    <a href="{{ Route('admin.player.management.normal.profile', $default_account->id) }}">
                                        <h1 class="text-white bg-black p-2 rounded-full font-semibold text-xxs uppercase">Update
                                        </h1>
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <div class="grid md:grid-cols-4 lg:grid-cols-6 gap-x-2 gap-y-4">
                                            @foreach ($player_video as $item)
                                                <div
                                                    ...
                                                    <video class="rounded-xl h-40 w-full object-cover" controls>
    ...
    <script>
        function openDropdown(event, activedropdownID) {
            let element = event.target;
            while (element.nodeName !== "BUTTON") {
                element = element.parentNode;
            }
            var popper = Popper.createPopper(element, document.getElementById(activedropdownID), {
                placement: 'bottom-start'
            });
            document.getElementById(activedropdownID).classList.toggle("hidden");
            document.getElementById(activedropdownID).classList.toggle("block");
        }
    </script>
