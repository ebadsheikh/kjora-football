...
@section('content')
            ...
            <div class="flex space-x-0.5"> 
                ...
                <div id="exportdropdown-id" class="hidden bg-export-btn rounded-b-lg p-1 text-center w-[7.3rem] export-style">
                    <ul class="flex flex-col gap-y-2">
                        <li>
                            <a href="{{Route('admin.stadium.export')}}" class="text-white font-medium uppercase text-xs ml-2">EXCEL</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="fixed bottom-5 right-3 lg:inset-y-2/3 lg:right-2">
        <div class="flex flex-col space-y-2">
            <a href="{{ route('admin.stadium.create') }}">
            ...
            <div
                ...
                <div class="relative px-6 flex-auto">
                    ...
                    <div class="pt-2 ">
                        ...
                        <div class="mt-2">
                            <div class="relative items-center">
                                <input type="text" id="stadium_end_date" autocomplete="off" name=""
                                ...
                                <span class="absolute top-2 right-3.5 date-icon-stadium-end">
                                    <img src="{{asset('assets/images/white-calender-icon.svg')}}" alt="">
                                </span>
                            </div>
        ...
        <script>
            ...
            new Chart("myChart", {
                ...
                options: {
                    title: {
                        display: true,
                        text: "Total Number Of Stadium Is "+ {{$count_stadium}}
                    }
                }
            });
        </script>
