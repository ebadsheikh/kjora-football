...
@section('content')
    <div class="py-12 px-5 md:mx-12 2xl:mx-32 2xl:mt-48">
        <form action="{{Route('admin.position.update', $positions->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
                @if (session('success'))
                <div class="p-2">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 2xl:gap-24 ">
                    <div class="bg-white px-5 py-9 lg:p-4 2xl:pt-6 h-auto lg:h-[36.125rem] xl:h-[37.125rem] 2xl:h-[43.5rem] rounded-2xl">
                        <h1
                            ...
                            update Position</h1>
                        <div class="xl:px-6 pt-5 pb-5 md:pt-60 md:pb-30">
...
<script>
    ...
    new Chart("myChart", {
      ...
      options: {
        title: {
          display: true,
          text: "Total number of position "+{{$count_position}}
        }
      }
    });
    </script>
