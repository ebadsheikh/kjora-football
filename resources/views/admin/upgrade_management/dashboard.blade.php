            ...
            <div class="flex space-x-0.5">
                <button typ="button">
                    <a href="{{ Route('admin.upgrade.management.upgrade.account') }}"
                        class="uppercase text-black bg-upgrade-btn font-semibold rounded-full text-xs p-1.5 md:px-4 py-1 text-center inline-flex items-center">
        ...
        <script>
            ...
            new Chart("myChart", {
                ...
                options: {
                    title: {
                        display: true,
                        text: "Total Number Of Upgrade Is 2"
                    }
                }
            });
        </script>
