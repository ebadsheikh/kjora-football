    ...
    <div class="container md:mx-auto">
        <div class="flex justify-center">
            <div class="w-11/12">
                <!--heading -->
                <div class="p-1">
                    <h1 class="uppercase text-white text-2xl md:text-5xl font-semibold tracking-wide">video
                    </h1>
                </div>
            </div>
        </div>
                            ...
                            <div class="p-3 md:px-6 py-6 md:px-10 md:py-10">
                                <div class="border border-border-gray rounded-3xl">
                                    <div class="grid grid-cols-1 lg:grid-cols-2">
                                        ...
                                        <div class="p-4">
                                            <div>
                                                <video class="rounded-xl h-56 md:h-96 w-full object-cover" controls preload="metadata">
                                                    <source src="{{ URL::asset($player_video->video) }}#t=0.1" type="video/mp4">
                                                </video>
                                            </div>
                                                    ...
                                                    <div class="hidden bg-border-gray pt-1 pb-px px-4 list-none text-left rounded-full"
                                                        ...
                                                        <ul class="flex gap-x-4">
                                                            @if ($player_info->id == session('player_id'))
                                                                ...
                                                                <li>
                                                                    @if ($player_info->membership_type == 'golden')
                                                                        <a href="{{Route('player.video.golden.delete', [$player_video->id, $player_info->id])}}">
                                                                            <img class="w-5 h-5 cursor-pointer"
                                                                                src="{{ asset('assets/images/white-trash-round.svg') }}">
                                                                        </a>
                                                                    @else
                                                                        <a href="{{Route('player.video.default.delete', [$player_video->id, $player_info->id])}}">
                                                                            <img class="w-5 h-5 cursor-pointer"
                                                                                src="{{ asset('assets/images/white-trash-round.svg') }}">
                                                                        </a>
                                                                    @endif
                                                                    {{-- <img class="w-5 h-5 cursor-pointer"
                                                                        src="{{ asset('assets/images/delete-icon.svg') }}"> --}}
                                                                </li>
                                                                <li>
                                                ...
                                                <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
                                                    ...
                                                    <div class="relative mx-auto w-72 md:w-80">
                                                        ...
                                                        <div
                                                            ...
                                                            <!--body -->
                                                            <form
                                                                action="{{ Route('player.update.video.caption', $player_video->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @if (session('success'))
                                                                    <div class="p-2">
                                            ...
                                            <div class="flex items-center justify-between ml-16">
                                                <h1 class="pr-2 text-xs text-gray-heading">
                                                    {{ $player_video->created_at->diffForHumans() }}
                                                    |{{ $player_video->created_at->format('H:i') }}</h1>
                                                    <div class="flex items-center">
                                                        <h1 class="text-sm mr-1" id="total_profile_like">{{$like_video_profile}}</h1>
                                                        <img class="w-4 h-4" src="{{session('profile_like') == $player_video->id ? asset('assets/images/heart-icon.svg') : asset('assets/images/empty-heart.svg')}}"
                                                        id="like_proile"
                                                        onclick="isProfileLike('{{ Session::get('player_id') }}','{{ $player_video->id }}','like_profile_{{$player_video->id}}')" />
                                                    </div>
                                        </div>
                                            <div class="py-1 ml-16">
                                                <p class="text-xs">{{ $player_video->caption }}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="lg:border-l-2">
                                            ...
                                            <div>
                                                <div class="p-2 space-y-4 h-[28rem] overflow-y-auto scroll">
                                                                ...
                                                                <div class="w-full">
                                                                    <div class="flex flex-col">
                                                                        ...
                                                                        <h1 class="md:hidden text-xs text-gray-heading">
                                                                            {{ $comments->created_at->diffForHumans() }} |
                                                                            {{ $comments->created_at->format('H:i') }}</h1>
                                                                        <div class="py-1">
                                                                        ...
                                                                        <div class="relative flex space-x-2">
                                                                            <button type="button"
                                                                                    ...
                                                                                    onclick="isFavorite('{{ Session::get('player_id') }}','{{ $comments->id }}','{{ $comments->video_id }}','like_comment_{{$comments->id}}')"
                                                                                class="text-black inline-flex text-xs font-medium">
                                                                                {{count($comments->commentlike)}} Likes</button>
                                                                            <button type="button"
                                                                                class="text-black text-xs font-medium" onclick="reply({{$key}})">Reply</button>
                                                                                ...
                                                                                <div class="flex">
                                                                                    ...
                                                                                    <div class="w-full">
                                                                                        <div class="flex flex-col">
                                                                                            ...
                                                                                            <h1 class="md:hidden text-xs text-gray-heading">
                                                                                                {{ $replies->created_at->diffForHumans() }} |
                                                                                                {{ $replies->created_at->format('H:i') }}</h1>
                                                                                            <div class="py-1">
                                                                                                <p class="text-xs break-all">
                                                                                            ...
                                                                                            <div class="relative flex space-x-2">
                                                                                                ...
                                                                                                <button type="button"
                                                                                                    ...
                                                                                                    class="text-black inline-flex text-xs font-medium">{{count($replies->likes)}} Likes</button>
                                                                                                <button type="button"
                                                                                                    class="text-black text-xs font-medium" onclick="reply({{$key}})">Reply</button>
                                                                        ...
                                                                        @endforeach
                                                                        <div class="vol relative hidden" id="show_reply{{$key}}">
                                                                            <form action="{{Route('player.store.reply')}}" method="post">
                                                                                @csrf
                                                                                @if (session('success'))
                                                                                <div class="p-2">
                                                                                    <div class="text-green-600 text-xs">
                                                                                ...
                                                                                @endif
                                                                                <div class="mt-2 flex">
                                                                                    <img src="{{URL::asset(Session('image'))}}" class="rounded-full border-2 object-cover border-dark-green mr-2 h-8 md:h-10 w-8 md:w-10"alt="Logo" />
                                                                                        <textarea class="mr-2 grow p-2 h-9 text-xs border-2 rounded-full resize-none scroll"  placeholder="write a message.." name="reply"></textarea>
                                                                                            <button type="submit" class="absolute inset-y-0 right-3 md:right-4 text-sm font-semibold text-golden-yellow">
                                                                                                Post</button>
                                                                                                <input type="hidden" value="{{$comments->id}}" name="comment_id">
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <form action="{{ Route('player.store.comment') }}" method="post">
                                                    @csrf
                                                    @if (session('success'))
                                                    <div class="p-2">
                                                        <div class="text-green-600 text-xs">
                                                    ...
                                                    @endif
                                                    <div class="px-4 py-2 border-t-2 relative">
                                                        {{-- <img class="absolute top-3 left-0"
                                                        src="{{asset('assets/images/Icon feather-smile.png')}}"> --}}
                                                        {{-- <input class="w-full outline-none whitespace-normal" type="text"
                                                        placeholder="write a message.." name="comment"> --}}
                                                        <textarea class="w-full outline-none whitespace-normal resize-none" id="mytextarea" placeholder="write a message.."
                                                            name="comment">

                                                        </textarea>
                                                        <input type="hidden" value="{{ $player_video->id }}"
                                                            name="video_id">
                                                        @error('comment')
                                                            @include('errors.required_field', [
                                                                'message' => $message,
...
<script>
    function isFavorite(user_id, comment_id, video_id, image_id) {
            $.ajax({
                ...
                url: "{{ URL::to('/player/store/like/video') }}",
...
<script>
    function isReplyLike(user_id, reply_id, image_id) {
            ...
            $.ajax({
                ...
                url: "{{ URL::to('/player/store/reply/like') }}",
    ...
    function isProfileLike(user_id, profile_id, image_id) {
        ...
        //     }
            ...
            $.ajax({
                ...
                url: "{{ URL::to('/player/store/profile/like') }}",
