...
@section('content')
    <div class="py-12 px-5 2xl:mx-32 2xl:mt-48">
        <div class="grid lg:grid-cols-2 gap-x-4 lg:gap-x-8 2xl:gap-24">
            ...
            <div
                class="rounded-2xl bg-white pt-10 pb-3.5 px-3 md:px-5 lg:px-5 xl:px-12 2xl:py-28 h-auto lg:h-[36.125rem] xl:h-[37.125rem] 2xl:h-[43.5rem]">
                ...
                <a href="{{ route('admin.create.terms_and_conditions') }}">
                    <button
