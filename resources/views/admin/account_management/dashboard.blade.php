            ...
            <div
                ...
                <div class="relative px-6 py-2 flex-auto">
                    ...
                    <div class="pt-2 ">
                        ...
                        <div class="mt-2">
                            <div class="relative items-center">
                                <input type="text" id="account_start_date" autocomplete="off" name="search_by_date_added"
                        ...
                        <div class="mt-2">
                            <div class="relative items-center">
                                <input type="text" id="account_end_date" autocomplete="off" name="search_by_date_added"
                ...
                <div class="p-6 rounded-b">
                    <a href="{{Route('admin.account.management.list')}}">
                        <button
...
<script src="{{ asset('assets/custom/script/custom_calender_picker.js') }}"></script>
        ...
        <script>
            var xValues = ["Issue", "Sorted", "Unsorted", "Pending"];
            var yValues = [2, 3, 5, 4];
            var barColors = [
                "#b91d47",
                "#00aba9",
            ...
            new Chart("myChart", {
                ...
                options: {
                    title: {
                        display: true,
                        text: "Total Number Of Account Is 8"
                    }
                }
            });
        </script>
