...
<div class="fixed bottom-5 right-3 lg:inset-y-2/3 lg:right-2">
    <div class="flex flex-col space-y-4">
        <button class="bg-light-green text-white p-4 rounded-full ease-linear transition-all duration-150"
            type="button">
            <a href="{{Route('admin.ad.management.create')}}"><img class="w-5 h-5" src="{{asset('assets/images/add-icon.svg')}}"
                    alt=""></a>
        </button>
        ...
        <div
            ...
            <div class="relative px-6 py-2 flex-auto">
                ...
                <div class="pt-2 ">
                    ...
                    <div class="mt-2">
                        <input type="text"
                            class="border border-white bg-transparent text-xs font-medium rounded-full text-center w-full px-5 py-2.5 placeholder-border-gray text-border-gray"
                ...
                <div class="pt-2 ">
                    ...
                    <div class="mt-2">
                        <div class="relative items-center">
                            <input type="text" id="ad_start_date" autocomplete="off" name=""
                            ...
                            <span class="absolute top-2 right-3.5 date-icon-ad-start">
                    ...
                    <div class="mt-2">
                        <div class="relative items-center">
                            <input type="text" id="ad_end_date" autocomplete="off" name=""
                            ...
                            <span class="absolute top-2 right-3.5 date-icon-ad-end">
                                <img src="{{asset('assets/images/white-calender-icon.svg')}}" alt="">
                            </span>
                        </div>
                    </div>
            ...
            <div class="p-6 rounded-b">
                <button
                    ...
                    type="button" onclick="window.location='https://kjora.com/admin/ad-management/list';">
                    Apply
                </button>
            </div>
        </div>
...
<script src="{{ asset('assets/custom/script/custom_calender_picker.js') }}"></script>
        ...
        <script>
            var xValues = ["Published", "Unpublished", "Deleted"];
            var yValues = [{{$count_published}}, {{$count_unpublished}}, {{$count_deleted}}];
            var barColors = [
                "#1e7145",
                "#b91d47",
                "#e8c3b9",
            ...
            new Chart("myChart", {
                ...
                options: {
                    title: {
                        display: true,
                        text: "Total Number Of Ad Is "+ {{$count_management}}
                    }
                }
            });
        </script>
