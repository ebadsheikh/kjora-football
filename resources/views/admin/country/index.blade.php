                                    ...
                                    <a href="{{ Route('admin.country.edit', $item->id) }}">
                                        <div class=" border border-border-gray border-opacity-40 rounded-full w-full px-5 py-3 hover:bg-light-green hover:bg-opacity-40">
                                            <div class="flex space-x-2 items-center">
                                                <img class="w-5 h-5 rounded-full" src="{{ URL::asset($item->image) }}"
                                                    alt="">
    ...
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
        ...
        <div class="relative my-auto mx-auto w-72">
            ...
            <div
                ...
                <form action="{{ Route('admin.country.view') }}" method="get">
                    <!--body-->
                        ...
                        <div class="pt-2 ">
                            ...
                            <div class="mt-2">
                                <div class="relative items-center">
                                    <select
                                        class="appearance-none border border-white bg-transparent text-sm font-medium rounded-full text-border-gray text-center w-full px-5 py-2 placeholder-border-gray"
...
<script>
    ...
    var options = {
      title:'Total number of country '+{{$count_country}}
    };
