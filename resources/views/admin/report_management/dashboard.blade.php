...
@section('content')
            ...
            <div class="flex space-x-0.5">
                ...
                <div id="exportdropdown-id" class="hidden bg-export-btn rounded-b-lg p-1 text-center w-[7.3rem] export-style">
                    <ul class="flex flex-col gap-y-2">
                        <li>
                            <a href="{{Route('admin.report.management.export')}}" class="text-white font-medium uppercase text-xs ml-2">EXCEL</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="relative my-auto mx-auto w-72">
            ...
            <div
                ...
                <div class="flex justify-end px-3 py-1 rounded-t">
                    <button class="text-black float-right text-lg leading-none font-medium"
                        onclick="toggleModal('flagmodal-id')">
                        x
                    </button>
                </div>
                ...
                <div class="relative px-3 md:px-5 pb-6">
                    <h3 class="text-xl text-light-green text-center font-semibold uppercase">
                        report
                    </h3>
                    ...
                    <button class="w-full bg-black text-white text-sm font-medium uppercase py-2 px-4 rounded-full"
                        type="button">
                        update
                    </button>
                </div>
    ...
    <div class="hidden opacity-25 fixed inset-0 z-40 bg-black" id="flagmodal-id-backdrop"></div>
    <div class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center"
        id="modal-id">
        <div class="relative my-auto mx-auto w-72">
            <!--content-->
            <div
                ...
                <div class="relative px-6 py-4 flex-auto">
                    ...
                    <div class="pt-2 ">
                        ...
                        <div class="mt-2">
                            <input type="text" class="appearance-none border border-white bg-transparent text-sm font-medium rounded-full placeholder-border-gray text-center w-full px-5 py-2 text-border-gray" placeholder="Search report by name">
                        </div>
                    </div>
                </div>
                <!--footer-->
...
@section('script')
        ...
        <script>
            var xValues = ["Chat", "Player", "Restricted", "Unrestricted"];
            var yValues = [2, 3, 1, 2];
            var barColors = [
                "#b91d47",
                "#00aba9",
            ...
            new Chart("myChart", {
                ...
                options: {
                    title: {
                        display: true,
                        text: "Total Number Of Report Is 8"
                    }
                }
            });
        </script>
