                    ...
                    <div class="md:px-6 pt-8 md:pt-32 lg:py-24 xl:pt-36 2xl:pt-40">
                        <div class="mt-3">
                            ...
                            <div class="relative items-center">
                                <input class="appearance-none border border-border-gray border-opacity-40 bg-white text-gray-400 w-full py-3 px-5 rounded-full text-xs" name="name" placeholder="Enter Country" autocomplete="off">
                                @error('name')
                        ...
                        <div class="mt-3">
                            <label
                                ...
                                code</label>
                            <div class="relative items-center">
                                <input class="appearance-none border border-border-gray border-opacity-40 bg-white text-gray-400 w-full py-3 px-5 rounded-full text-xs" name="code" placeholder="Enter Code" autocomplete="off">
                                @error('code')
                                    @include('errors.required_field', ['message' => $message])
                                @enderror
                            </div>
                        ...
                        <div class="flex justify-center my-3">
                            {{-- <button
                                ...
                                <div class="relative">
                                    ...
                                    <img class="w-12 h-12 rounded-full -top-5 -right-2 md:-top-7 lg:-top-8 md:right-1" src="{{asset('assets/images/add-icon.svg')}}" alt="image" id="thumbnil">
                                </div>
                            </button> --}}
                            <div class="relative">
                                <input type="file" accept="image/*" onchange="showMyImage(this)" name="image" class="hidden" id="profile_image"/>
                                <img class="w-12 h-12 rounded-full -top-5 -right-2 md:-top-7 lg:-top-8 md:right-1" src="{{asset('assets/images/add_icon.png')}}" alt="image" id="thumbnil">
                            </div>
                        </div>
                        @error('image')
                            @include('errors.required_field', ['message' => $message])
