                    ...
                    <form>
                        <div class="grid grid-cols-2 gap-2 2xl:gap-y-6">
                            <div class="col-span-2 md:col-span-1">
                                <label>
                                    <div class="flex items-center px-4 mb-1">
                                        <img class="w-5 h-5" src="{{ asset('assets/images/filled-star.svg') }}"
                                            alt="">
                                        <img class="w-5 h-5" src="{{ asset('assets/images/filled-star.svg') }}"
                                            alt="">
                                        <img class="w-5 h-5" src="{{ asset('assets/images/filled-star.svg') }}"
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input type="text"
                                    class="border border-border-gray border-opacity-40 text-xs rounded-full w-full px-5 py-3 placeholder-dark-gray placeholder-opacity-40"
                                    placeholder="" value="{{$first_price->price}}" disabled>
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label>
                                    <div class="flex items-center px-4 mb-1">
                                        ...
                                        <img class="w-5 h-5" src="{{ asset('assets/images/filled-star.svg') }}"
                                            alt="">
                                        <img class="w-5 h-5" src="{{ asset('assets/images/empty-star.svg') }}"
                                            alt="">
                                    </div>
                                </label>
                                <input type="text"
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input type="text"
                                    class="border border-border-gray border-opacity-40 text-xs rounded-full w-full px-5 py-3 placeholder-dark-gray placeholder-opacity-40"
                                    placeholder="" value="{{$second_price->price}}" disabled>
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label>
                                    <div class="flex items-center px-4 mb-1">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input type="text"
                                    class="border border-border-gray border-opacity-40 text-xs rounded-full w-full px-5 py-3 placeholder-dark-gray placeholder-opacity-40"
                                    placeholder="" value="{{$third_price->price}}" disabled>
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label>
                                    <div class="flex items-center px-4 mb-1">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input type="text"
                                    class="border border-border-gray border-opacity-40 text-xs rounded-full w-full px-5 py-3 placeholder-dark-gray placeholder-opacity-40"
                                    placeholder="$10" value="{{$fourth_price->price}}" disabled>
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label>
                                    <div class="flex items-center px-4 mb-1">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input type="text"
                                    class="border border-border-gray border-opacity-40 text-xs rounded-full w-full px-5 py-3 placeholder-dark-gray placeholder-opacity-40"
                                    placeholder="" value="{{$fifth_price->price}}" disabled>
                            </div>
                            <div class="col-span-2 mt-4">
                                <a href="{{ Route('admin.rating.management.rating') }}">
                                    <button
                                        class="w-full bg-black text-white font-medium uppercase py-3 px-4 rounded-full ease-linear transition-all duration-150"
                                        type="button">
                                        next
                                    </button>
                                </a>
            ...
            <div
                ...
                <div class="md:px-6 lg:px-1 xl:px-6">
                    <div class="flex justify-center my-20">
                        <div class="rounded-3xl h-[13.813rem] w-80 px-4 py-9"
                            style="background-image: url('{{ asset('assets/images/small-default.png') }}');">
                            <div>
                                <a href="#" class="flex items-center">
                                    <div class="rounded-full bg-light-green mr-2 w-14 h-14"> </div>
