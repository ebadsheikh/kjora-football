            ...
            <div class="flex space-x-0.5">
                ...
                <div id="exportdropdown-id" class="hidden bg-export-btn rounded-b-lg p-1 text-center w-[7.3rem] export-style">
                    <ul class="flex flex-col gap-y-2">
                        <li>
                            <a href="{{Route('admin.verification.management.export')}}" class="text-white font-medium uppercase text-xs ml-2">EXCEL</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div
                ...
                <div class="relative px-6 pt-4 flex-auto">
                    <div class="pt-2">
                        ...
                        <div class="mt-2">
                            <input type="text"
                                class="border border-white bg-transparent text-sm text-border-gray font-medium rounded-full text-center w-full px-5 py-2.5 placeholder-border-gray "
                    ...
                    <div class="pt-2 ">
                        ...
                        <div class="mt-2">
                            <div class="relative items-center">
                                <input type="text" id="verification_start_date" autocomplete="off" name="search_by_date_added"
                                    ...
                                    <span class="absolute top-2 right-3.5 date-icon-verification-start">
                        ...
                        <div class="mt-2">
                            <div class="relative items-center">
                                <input type="text" id="verification_end_date" autocomplete="off" name="search_by_date_added"
                                    ...
                                    <span class="absolute top-2 right-3.5 date-icon-verification-end">
                                        <img src="{{asset('assets/images/white-calender-icon.svg')}}" alt="">
                                    </span>
                            </div>
                        </div>
                ...
                <div class="p-6 rounded-b">
                    <a href="{{Route('admin.verification.management.list')}}">
                    <button
...
<script src="{{ asset('assets/custom/script/custom_calender_picker.js') }}"></script>
        ...
        <script>
            var xValues = ["Pending", "Verified", "Unverified"];
            var yValues = [3, 2, 1];
            var barColors = [
                "#1e7145",
                "#b91d47",
            ...
            new Chart("myChart", {
                ...
                options: {
                    title: {
                        display: true,
                        text: "Total Number Of Verified Is 6"
                    }
                }
            });
        </script>
