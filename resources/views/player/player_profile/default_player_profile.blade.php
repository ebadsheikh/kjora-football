                                ...
                                <div class="flex justify-between">
                                    <div>
                                        <div class="flex items-center">
                                            ...
                                            @endif
                                            {{-- <img src="{{ URL::asset($player->profile_image) }}"
                                                class="object-cover rounded-full border-2 border-black mr-3 h-12 w-12 md:h-16 md:w-16 "
                                                alt="Logo" /> --}}
                                ...
                                <div class="my-3">
                                    <div class="flex lg:mx-20 justify-between">
                                        <div class="text-center">
                                            <h1 class="text-heading-white text-opacity-25 text-xs md:text-sm">
                                                Favourite club</h1>
                                        ...
                                        <div class="text-center">
                                            <h1 class="text-heading-white text-opacity-25 text-xs md:text-sm">Age
                                            </h1>
                                            @if ($card_detail->age == 1)
                                                <h2 class="text-white text-xs md:text-sm">
                                                    {{ get_age_from_birth_date($player->date_of_birth) }}</h2>
                                            @endif
                                        </div>
                                        <div class="text-center">
                                            <h1 class="text-heading-white text-opacity-25 text-xs md:text-sm">Played
                                            </h1>
                                        ...
                                        <div class="text-center">
                                            <h1 class="text-heading-white text-opacity-25 text-xs md:text-sm">Missed
                                            </h1>
                                        ...
                                        <div class="text-center">
                                            ...
                                            @if ($card_detail->position == 1)
                                                <h2 class="text-white text-xs md:text-sm">{{ $player->position['name'] }}
                                                </h2>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="mt-2 flex items-center justify-between">
                                    <div class="flex gap-x-2 items-center">
                                        ...
                                        @if ($card_detail->location == 1)
                                            <h1 class="text-white text-xxs md:text-xs">
                                    ...
                                    <div class="flex gap-x-2 items-center">
                                        ...
                                        <a href="#" class="text-white text-xxs md:text-xs">Send invitation >></a>
                                        @endif
                                        <button class=" ease-linear transition-all duration-150" type="button"
                                            onclick="openDropdown(event,'dropdown-id')">
                                            <div class="flex items-center">
                                                <img class="w-5 h-5"  src="{{ asset('assets/images/Path 303.svg') }}" alt="">
                                            </div>
                                        </button>
                        ...
                        <div id="tabs-id">
                            <div class="rounded-full p-3 bg-heading-white bg-opacity-62 ">
                                <ul class="flex justify-center space-x-4">
                                    <li>
                                        <a class="uppercase text-base text-border-gray cursor-pointer font-medium {{ isset($tab) ? ($tab == 'tab-performance' ? 'text-black' : '') : 'text-black'}}"
                                            onclick="changeAtiveTab(event,'tab-performance')">
                                            Performance
                                        </a>
                                    </li>
                                    <li>
                                        <a class="uppercase text-base text-border-gray cursor-pointer font-medium {{ (isset($tab) && $tab == 'tab-photos') ? 'text-black' : ''}}"
                                            onclick="changeAtiveTab(event,'tab-photos')">
                                            photos
                                        </a>
                                    </li>
                                    <li>
                                        <a class="uppercase text-base text-border-gray cursor-pointer font-medium {{ (isset($tab) && $tab == 'tab-videos') ? 'text-black' : ''}}"
                                    ...
                                    <div class="{{ (isset($tab) && $tab == 'tab-photos') ? 'block' : 'hidden relative '}}" id="tab-photos">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="hidden group-hover:block absolute inset-x-0 bottom-1">
                                                            <div class="flex justify-between items-center gap-2">
                                                                <h1 class="text-white text-xxs px-1 truncate">
                                                                    {{ $item->caption }}</h1>
                                                                <div class="pr-1">
                                                                    <img
                                        ...
                                        {{-- fixed bottom-8 right-3 md:absolute md:right-[-4rem] md:bottom-16 --}}
                                            <div class="fixed bottom-20 right-5 2xl:bottom-[6.75rem] 2xl:right-[2.5rem]">
                                                <button
                                                    class="bg-light-green text-white h-[60px] min-w-[60px] p-5 rounded-full ease-linear transition-all duration-150"
                                    ...
                                    <div class="{{ (isset($tab) && $tab == 'tab-videos') ? 'block' : 'hidden relative '}}" id="tab-videos">
                                        <div class="grid md:grid-cols-4 lg:grid-cols-6 gap-y-4">
                                            @foreach ($player_video as $item)
                                                <div class="group border-2 border-dark-green rounded-xl relative cursor-pointer">
                                                    <div
                                                        class="hidden group-hover:block absolute inset-0 bg-photo-overlay bg-opacity-60 rounded-xl">
                                                    </div>
                                                    <video class="rounded-xl h-40 w-full object-cover" preload="metadata">
                                                        <source src="{{ URL::asset($item->video) }}#t=0.1" type="video/mp4">
                                                    </video>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="my-3">
                                                                    ...
                                                                    <input
                                                                        class="border border-border-gray border-opacity-40 text-xs rounded-full w-full px-5 py-3 placeholder-dark-gray placeholder-opacity-40"
                                                                        type="text" placeholder="Please write caption"
                                                                        name="caption_video" value="{{old('caption_video')}}">
                                                                    @error('caption_video')
                                                                        @include('errors.required_field', [
                                                                            'message' => $message,
                                                                        ])
                                                                    ...
                                                                    <div class="flex flex-col justify-center space-y-4">
                                                                        ...
                                                                        @error('video')
                                                                            @include('errors.required_field',
                                                                                ['message' => $message])
                                                                        @enderror
                                                                        <div class="mx-auto rounded-lg object-cover w-40 h-40">
                                                                            <video
                                                                                class="w-40 h-40 hidden" id="video_show_here"
                                                                                controls>
        ...
        function showMyPhoto(fileInput) {
            ...
            postData = new FormData();
                ...
                $.ajax({
                    ...
                    url     : '{{ route('player.default.profile.photo') }}',
                    data    : postData,
                    dataType: 'json',
                    processData: false,
                    contentType: false,
