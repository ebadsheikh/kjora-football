...
<div class="p-4 md:py-10 md:px-16">
    ...
    <div class="flex space-x-2 items-center justify-end">
        <div>
            <a href="{{Route('admin.invitation.management.edit')}}">
            ...
            <button onclick="openDropdown(event,'exportdropdown-id')"
                ...
                <div id="exportdropdown-id" class="hidden bg-export-btn rounded-b-lg p-1 text-center w-[7.3rem] export-style">
                    <ul class="flex flex-col gap-y-2">
                        <li>
                            <a href="{{Route('admin.invitation.management.export')}}" class="text-white font-medium uppercase text-xs ml-2">EXCEL</a>
                        </li>
                    </ul>
                </div>
        </div>
    ...
    <div class="relative my-auto mx-auto w-72">
        ...
        <div
            ...
            <div class="flex items-start justify-between px-5 pt-2 rounded-t">
                ...
                <button class="text-white float-right text-lg leading-none font-normal"
                    onclick="toggleModal('modal-id')">
                    x
                </button>
            </div>
                ...
                <div class="pt-2 ">
                    ...
                    <div class="mt-2">
                        <div class="relative items-center">
                            <input type="text" id="invitation_start_date" autocomplete="off" name="search_by_date_added"
                                class="appearance-none border border-white bg-transparent text-sm font-medium rounded-full text-border-gray placeholder-border-gray text-center w-full px-5 py-2.5" placeholder="Start Date">
                    ...
                    <div class="mt-2">
                        <div class="relative items-center">
                            <input type="text" id="invitation_end_date" autocomplete="off" name="search_by_date_ended"
                                class="appearance-none border border-white bg-transparent text-sm font-medium rounded-full text-border-gray placeholder-border-gray text-center w-full px-5 py-2.5" placeholder="End Date">
            ...
            <div class="p-6 rounded-b">
                <a href="{{Route('admin.invitation.management.list')}}">
                    <button
...
@section('script')
        ...
        <script>
            var xValues = ["Invite", "Hire", "Pending", "Accept", "Reject"];
            var yValues = [3, 2, 1, 5, 6];
            var barColors = [
                "#b91d47",
                "#00aba9",
                "#2b5797",
            ...
            new Chart("myChart", {
                ...
                options: {
                    title: {
                        display: true,
                        text: "Total Number Of Invite Is 17"
                    }
                }
            });
        </script>
